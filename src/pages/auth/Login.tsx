const Login = () => {
  return (
    <section>
      <div className="min-h-[100vh] lg:flex lg:justify-between">
        <div className="flex flex-col justify-center flex-1 px-4 py-12 bg-white sm:px-6 lg:px-20 xl:px-24">
          <div className="flex-1 max-w-sm mx-auto lg:max-w-md">
            ...
            <h1 className="mt-10 text-3xl font-bold text-center text-gray-900 lg:mt-20 xl:mt-32 sm:text-4xl  lg:text-left">
              Welcome back to Healthcare Workforce System
            </h1>
